...
# 카메라 (2.0,0,2.0) 기준 작업영역까지 2.55m라 focal별로:
#   48mm -> 1.11m 폭, 큐브 14px | 70mm -> 0.76m, 21px | 80mm -> 0.67m, 24px
# 상한이 있다: 이미지 가로축이 월드 y축에 대응하고 화면 중심이 y=0인데,
# 큐브 영역(y 0.25)과 목표점(y -0.15)을 다 담으려면 y로 ±0.275m 이상 필요하다.
# -> focal 97mm를 넘으면 목표 마커가 프레임을 벗어난다. 80mm면 ±0.334m로 여유.
OVER_FOCAL  = 80.0
